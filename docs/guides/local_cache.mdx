...
etebase_utils_to_base64(cache_blob, cache_size, cache_64, sizeof(cache_64));

// Later on we can load the object back
char decoded[ETEBASE_UTILS_FROM_BASE64_MAX_LEN(strlen(cache_64))];
uintptr_t decoded_len = 0;
etebase_utils_from_base64(cache_64, decoded, sizeof(decoded), &decoded_len);
