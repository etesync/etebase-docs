...
When creating collections, you need to pass the [collection type](../overview#collection-type) as the first parameter, followed by the metadata and the content.
