...
When creating collections, you need to pass the [collection type](../overview#collection-type) as the first parameter, followed by the [metadata](../overview#metadata-1) and the content.
